...
public class FM.ListModel : GLib.Object, Gtk.TreeModel, Gtk.TreeDragDest, Gtk.TreeSortable {
    ...
    private GLib.Sequence<FileEntry?> files = null;
    private Gee.TreeMap<GOF.File, GLib.SequenceIter<weak FileEntry?>> top_reverse_map;
    private Gee.TreeMap<GOF.Directory.Async, GLib.SequenceIter<weak FileEntry?>> directory_reverse_map;
    private int stamp;
    private bool sort_directories_first;
    private ColumnID sort_id;
    private Gtk.SortType order;

    construct {
        files = new GLib.Sequence<FileEntry?> ();
        top_reverse_map = new Gee.TreeMap<GOF.File, GLib.SequenceIter<weak FileEntry?>> ();
        directory_reverse_map = new Gee.TreeMap<GOF.Directory.Async, GLib.SequenceIter<weak FileEntry?>> ();
        stamp = (int)GLib.Random.next_int ();
        sort_id = ColumnID.FILENAME;
        order = Gtk.SortType.ASCENDING;
    }

    private GLib.SequenceIter<weak FileEntry?> lookup_file (GOF.File file, GOF.Directory.Async? directory = null) {
        GLib.SequenceIter<weak FileEntry?> parent_seq = null;
        if (directory != null) {
    ...
    public void file_changed (GOF.File file, GOF.Directory.Async dir) {
        ...
        if (pos_before != pos_after) {
            ...
            unowned FileEntry* parent_file_entry = (FileEntry*)seq.get ().parent;
    ...
    private void remove (Gtk.TreeIter iter) {
        ...
        unowned FileEntry* parent = (FileEntry*)file_entry.parent;
    ...
    private int file_entry_compare_func (FileEntry? file_entry1, FileEntry? file_entry2) {
        ...
        if (file1 != null && file2 != null &&
            ...
            return GOF.File.compare_for_sort (file1, file2, sort_id, true, order == Gtk.SortType.DESCENDING);
